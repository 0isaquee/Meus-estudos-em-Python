...
⚙ Este foi meu primeiro código feito de maneira manual, com pouquísima ajuda de Inteligência Artificial. 
Fiquei feliz com resultado e aprendizado retido no decorrer do desenvolvimento do código e vou dar um pincelada de como ele funciona.
...
Neste código eu aprendi muita coisa, envolvendo principalmente **while, if, elif e else, capitalize, lower** etc.<br>
🎯 Como já dito, fiquei feliz com o resultado e vou ir atrás de criar um site com html e css para essa loja de materias. 

🛠 Acho que vou chamar ela de PYrafusos e CONSTruções.
